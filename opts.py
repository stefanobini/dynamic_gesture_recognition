...
def parse_opts():
    ...
    parser.add_argument('--modality', default='RGB', type=str, help='Modality of input data. RGB, Flow or RGBFlow (RGB | D | MHI | MHI_D | OF | OF_D)')
    ...
    parser.add_argument('--aggr_type', default='avg', type=str, help='(MLP | LSTM | avg | max')
