...
```bash
 -W ignore
RESNEXT-101
python3 main.py --root_path ./ --video_path ../../../../mnt/sdc1/sbini/nvgesture --annotation_path annotation_NVGesture/nvgesture.json --result_path results/nvgesture --pretrain_path pretrained_models/jester_resnext_101_RGB_16_best.pth --dataset nvgesture --n_classes 27 --n_finetune_classes 25 --ft_portion complete --model resnext --model_depth 101 --groups 3 --train_crop random --scale_step 0.95 --n_epochs 60 --lr_steps 15 30 --learning_rate 0.1 --sample_duration 16 --downsample 2 --batch_size 32 --n_threads 4 --checkpoint 1 --n_val_samples 1 --no_hflip --modalities RGB --gpu 3
